      ...
      return (
        ...
        (t._getRootElement = function(t) {
          var e = Fn.getSelectorFromElement(t),
            n = !1;
          return (
            e && (n = document.querySelector(e)), n || (n = r(t).closest('.' + f)[0]), n
          );
        }),
      ...
      return (
        ...
        (t._getPopperConfig = function() {
          ...
          'function' == typeof this._config.offset
            ? (t.fn = function(t) {
                return (
                  (t.offsets = l({}, t.offsets, e._config.offset(t.offsets) || {})), t
                );
              })
      ...
      return (
        ...
        (t.hide = function(t) {
          ...
          if ((t && t.preventDefault(), !this._isTransitioning && this._isShown)) {
            ...
            if (
              ($t(this._element).trigger(n), this._isShown && !n.isDefaultPrevented())
            ) {
              this._isShown = !1;
        ...
        (r._jQueryInterface = function(n, i) {
          return this.each(function() {
            ...
            if (
              (t || ((t = new r(this, e)), $t(this).data(te, t)), 'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n])
                throw new TypeError('No method named "' + n + '"');
              t[n](i);
      ...
      return (
        ...
        (t._setListeners = function() {
          ...
          this.config.trigger.split(' ').forEach(function(t) {
            if ('click' === t)
              pe(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(
                t
              ) {
                return i.toggle(t);
              });
      ...
      return (
        ...
        (n._jQueryInterface = function(e) {
          return this.each(function() {
            ...
            if (
              (t ||
                ((t = new n(this, 'object' == typeof e && e)), tn(this).data(nn, t)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof t[e])
                throw new TypeError('No method named "' + e + '"');
